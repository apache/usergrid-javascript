...
(function() {
  ...
  //   var uri = UsergridHelpers.urljoin(this.baseUrl,self.orgId,self.appId,options.endpoint);
  //   var qs = options.qs || {};
  //   var body = options.body || {};
  //
  //   var request = function() {
  //     return new UsergridRequest({ method:method, uri:uri, body:body, qs:qs });
  //   }.bind(this);
  //
  ...
  // };
  //
  //   Usergrid.Client.prototype.performRequest = function(request, callback) {
  //       var self = this;
  //       var requestFunc = function() {
  //        return request
  //       }.bind(this);
  //
  //       var response = function(createdRequest) {
  //         return new UsergridResponse(createdRequest);
  //       }.bind(self);
  //
  //       var p = new Promise();
  //       var onComplete = function (response) {
  ...
  //
  //       /* and a promise to chain them all together */
  //       Promise.chain([requestFunc,response]).then(onComplete);
  //       return p;
  //     };
  //
  // Usergrid.Client.prototype.GET = function(options, callback) {
  //   var self = this;
  //   return self.performRequest(new UsergridRequest({
  //         method: UsergridHttpMethod.GET,
  //         uri: UsergridHelpers.urljoin(self.baseUrl, self.orgId, self.appId, options.endpoint),
  //         qs: options.qs || {},
  //         body: options.body || {}
  //       }), callback)
  //     };
  //
  // Usergrid.Client.prototype.PUT = function(options, callback) {
  //   var self = this;
  //   return self.performRequest(new UsergridRequest({
  ...
  //     };
  //
  // Usergrid.Client.prototype.POST = function(options, callback) {
  //   var self = this;
  //   return self.performRequest(new UsergridRequest({
  ...
  //     };
  //
  // Usergrid.Client.prototype.DELETE = function(options, callback) {
  //   var self = this;
  //   return self.performRequest(new UsergridRequest({
