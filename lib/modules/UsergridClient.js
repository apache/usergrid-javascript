...
UsergridClient.prototype = {
    ...
    downloadAsset: function(entity,callback) {
        var self = this
        var uploadRequest = new UsergridRequest({client:self, method:UsergridHttpMethod.GET, uri:UsergridHelpers.uri(self,UsergridHttpMethod.GET,entity)})
    ...
    uploadAsset: function(entity,asset,callback) {
        ...
        var uploadRequest = new UsergridRequest({client:self, method:method, uri:UsergridHelpers.uri(self,method,entity), asset:asset})
