...
describe('Usergrid', function(){
    ...
    describe('Usergrid Request/Response', function() {
        ...
        it('should POST to a URI',function(done){
            var req=new Usergrid.Request("POST", dogURI, {}, dogData, function(response){
        ...
        it('should GET a URI',function(done){
            var req=new Usergrid.Request("GET", dogURI+'/'+dogName, {}, null, function(response){
                assert(!response.error, response.error);
                assert(response instanceof UsergridResponse, "Response is not and instance of UsergridResponse");
                done();
            })
        ...
        it('should GET an array of entity data from the Usergrid.Response object',function(done){
            var req=new Usergrid.Request("GET", dogURI, {}, null, function(response){
                // assert(!err, err);
                assert(!response.error, response.error);
                assert(response.entities && response.entities.length, "Nothing was returned")
                done();
            })
        })
        ...
        it('should PUT to a URI',function(done){
            var req=new Usergrid.Request("PUT", dogURI+'/'+dogName, {}, {favorite:true}, function(response){
                assert(!response.error, response.error);
                assert(response instanceof UsergridResponse, "Response is not and instance of UsergridResponse");
                done();
            })
        ...
        it('should DELETE a URI',function(done){
            var req=new Usergrid.Request("DELETE", dogURI+'/'+dogName, {}, null, function(response){
                assert(!response.error, response.error);
                assert(response instanceof UsergridResponse, "Response is not and instance of UsergridResponse");
                done();
            })
