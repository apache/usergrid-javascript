...
describe('Client Connections', function() {
    ...
    describe('connect()', function () {
        ...
        before(function (done) {
            ...
            client.POST({type:config.test.collection, body:[{ "name": "testClientConnectOne"}, {"name": "testClientConnectTwo"}]}, function (postResponse) {
                entity1 = postResponse.first
                entity2 = postResponse.last
                done()
            })
        });
    ...
    describe('disconnect()', function () {
        ...
        after(function (done) {
            ...
            client.DELETE(deleteQuery, function () {
                done()
            })
        });
